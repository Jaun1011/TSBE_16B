...
Zuerst wird auf dem Jumphost der Ordner ceph erstetlt.
	...
	[s1-node2][DEBUG ] connection detected need for sudo
	[s1-node2][DEBUG ] connected to host: s1-node2 
	[s1-node2][DEBUG ] detect platform information from remote host
	[s1-node2][DEBUG ] detect machine type
	[s1-node2][DEBUG ] find the location of an executable
	[ceph_deploy.mon][INFO  ] distro info: Ubuntu 16.04 xenial
	[s1-node2][DEBUG ] determining if provided host has same hostname in remote
	[s1-node2][DEBUG ] get remote short hostname
	[s1-node2][DEBUG ] deploying mon to s1-node2
	[s1-node2][DEBUG ] get remote short hostname
	[s1-node2][DEBUG ] remote hostname: s1-node2
	[s1-node2][DEBUG ] write cluster configuration to /etc/ceph/{cluster}.conf
	[s1-node2][DEBUG ] create the mon path if it does not exist
	[s1-node2][DEBUG ] checking for done path: /var/lib/ceph/mon/ceph-s1-node2/done
	[s1-node2][DEBUG ] done path does not exist: /var/lib/ceph/mon/ceph-s1-node2/done
	[s1-node2][INFO  ] creating keyring file: /var/lib/ceph/tmp/ceph-s1-node2.mon.keyring
	[s1-node2][DEBUG ] create the monitor keyring file
	[s1-node2][INFO  ] Running command: sudo ceph-mon --cluster ceph --mkfs -i s1-node2 --keyring /var/lib/ceph/tmp/ceph-s1-node2.mon.keyring --setuser 64045 --setgroup 64045
	[s1-node2][DEBUG ] ceph-mon: mon.noname-b 10.132.0.16:6789/0 is local, renaming to mon.s1-node2
	[s1-node2][DEBUG ] ceph-mon: set fsid to 27f1d85f-9b95-4f1e-bd3b-3e8a2cb70e95
	[s1-node2][DEBUG ] ceph-mon: created monfs at /var/lib/ceph/mon/ceph-s1-node2 for mon.s1-node2
	[s1-node2][INFO  ] unlinking keyring file /var/lib/ceph/tmp/ceph-s1-node2.mon.keyring
	[s1-node2][DEBUG ] create a done file to avoid re-doing the mon deployment
	[s1-node2][DEBUG ] create the init path if it does not exist
	[s1-node2][INFO  ] Running command: sudo systemctl enable ceph.target
	[s1-node2][INFO  ] Running command: sudo systemctl enable ceph-mon@s1-node2
	[s1-node2][WARNIN] Created symlink from /etc/systemd/system/ceph-mon.target.wants/ceph-mon@s1-node2.service to /lib/systemd/system/ceph-mon@.service.
	[s1-node2][INFO  ] Running command: sudo systemctl start ceph-mon@s1-node2
	[s1-node2][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node2.asok mon_status
	[s1-node2][DEBUG ] ********************************************************************************
	[s1-node2][DEBUG ] status for monitor: mon.s1-node2
	[s1-node2][DEBUG ] {
	[s1-node2][DEBUG ]   "election_epoch": 1, 
	[s1-node2][DEBUG ]   "extra_probe_peers": [
	[s1-node2][DEBUG ]     "10.132.0.15:6789/0", 
	[s1-node2][DEBUG ]     "10.132.0.17:6789/0"
	[s1-node2][DEBUG ]   ], 
	[s1-node2][DEBUG ]   "monmap": {
	[s1-node2][DEBUG ]     "created": "2018-02-17 09:30:20.701836", 
	[s1-node2][DEBUG ]     "epoch": 0, 
	[s1-node2][DEBUG ]     "fsid": "27f1d85f-9b95-4f1e-bd3b-3e8a2cb70e95", 
	[s1-node2][DEBUG ]     "modified": "2018-02-17 09:30:20.701836", 
	[s1-node2][DEBUG ]     "mons": [
	[s1-node2][DEBUG ]       {
	[s1-node2][DEBUG ]         "addr": "10.132.0.16:6789/0", 
	[s1-node2][DEBUG ]         "name": "s1-node2", 
	[s1-node2][DEBUG ]         "rank": 0
	[s1-node2][DEBUG ]       }, 
	[s1-node2][DEBUG ]       {
	[s1-node2][DEBUG ]         "addr": "10.132.0.17:6789/0", 
	[s1-node2][DEBUG ]         "name": "s1-node1", 
	[s1-node2][DEBUG ]         "rank": 1
	[s1-node2][DEBUG ]       }, 
	[s1-node2][DEBUG ]       {
	[s1-node2][DEBUG ]         "addr": "0.0.0.0:0/2", 
	[s1-node2][DEBUG ]         "name": "s1-node3", 
	[s1-node2][DEBUG ]         "rank": 2
	[s1-node2][DEBUG ]       }
	[s1-node2][DEBUG ]     ]
	[s1-node2][DEBUG ]   }, 
	[s1-node2][DEBUG ]   "name": "s1-node2", 
	[s1-node2][DEBUG ]   "outside_quorum": [], 
	[s1-node2][DEBUG ]   "quorum": [], 
	[s1-node2][DEBUG ]   "rank": 0, 
	[s1-node2][DEBUG ]   "state": "electing", 
	[s1-node2][DEBUG ]   "sync_provider": []
	[s1-node2][DEBUG ] }
	[s1-node2][DEBUG ] ********************************************************************************
	[s1-node2][INFO  ] monitor: mon.s1-node2 is running
	[s1-node2][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node2.asok mon_status
	[ceph_deploy.mon][DEBUG ] detecting platform for host s1-node3 ...
	[s1-node3][DEBUG ] connection detected need for sudo
	[s1-node3][DEBUG ] connected to host: s1-node3 
	[s1-node3][DEBUG ] detect platform information from remote host
	[s1-node3][DEBUG ] detect machine type
	[s1-node3][DEBUG ] find the location of an executable
	[ceph_deploy.mon][INFO  ] distro info: Ubuntu 16.04 xenial
	[s1-node3][DEBUG ] determining if provided host has same hostname in remote
	[s1-node3][DEBUG ] get remote short hostname
	[s1-node3][DEBUG ] deploying mon to s1-node3
	[s1-node3][DEBUG ] get remote short hostname
	[s1-node3][DEBUG ] remote hostname: s1-node3
	[s1-node3][DEBUG ] write cluster configuration to /etc/ceph/{cluster}.conf
	[s1-node3][DEBUG ] create the mon path if it does not exist
	[s1-node3][DEBUG ] checking for done path: /var/lib/ceph/mon/ceph-s1-node3/done
	[s1-node3][DEBUG ] done path does not exist: /var/lib/ceph/mon/ceph-s1-node3/done
	[s1-node3][INFO  ] creating keyring file: /var/lib/ceph/tmp/ceph-s1-node3.mon.keyring
	[s1-node3][DEBUG ] create the monitor keyring file
	[s1-node3][INFO  ] Running command: sudo ceph-mon --cluster ceph --mkfs -i s1-node3 --keyring /var/lib/ceph/tmp/ceph-s1-node3.mon.keyring --setuser 64045 --setgroup 64045
	[s1-node3][DEBUG ] ceph-mon: mon.noname-c 10.132.0.15:6789/0 is local, renaming to mon.s1-node3
	[s1-node3][DEBUG ] ceph-mon: set fsid to 27f1d85f-9b95-4f1e-bd3b-3e8a2cb70e95
	[s1-node3][DEBUG ] ceph-mon: created monfs at /var/lib/ceph/mon/ceph-s1-node3 for mon.s1-node3
	[s1-node3][INFO  ] unlinking keyring file /var/lib/ceph/tmp/ceph-s1-node3.mon.keyring
	[s1-node3][DEBUG ] create a done file to avoid re-doing the mon deployment
	[s1-node3][DEBUG ] create the init path if it does not exist
	[s1-node3][INFO  ] Running command: sudo systemctl enable ceph.target
	[s1-node3][INFO  ] Running command: sudo systemctl enable ceph-mon@s1-node3
	[s1-node3][WARNIN] Created symlink from /etc/systemd/system/ceph-mon.target.wants/ceph-mon@s1-node3.service to /lib/systemd/system/ceph-mon@.service.
	[s1-node3][INFO  ] Running command: sudo systemctl start ceph-mon@s1-node3
	[s1-node3][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node3.asok mon_status
	[s1-node3][DEBUG ] ********************************************************************************
	[s1-node3][DEBUG ] status for monitor: mon.s1-node3
	[s1-node3][DEBUG ] {
	[s1-node3][DEBUG ]   "election_epoch": 3, 
	[s1-node3][DEBUG ]   "extra_probe_peers": [
	[s1-node3][DEBUG ]     "10.132.0.16:6789/0", 
	[s1-node3][DEBUG ]     "10.132.0.17:6789/0"
	[s1-node3][DEBUG ]   ], 
	[s1-node3][DEBUG ]   "monmap": {
	[s1-node3][DEBUG ]     "created": "2018-02-17 09:30:23.686709", 
	[s1-node3][DEBUG ]     "epoch": 1, 
	[s1-node3][DEBUG ]     "fsid": "27f1d85f-9b95-4f1e-bd3b-3e8a2cb70e95", 
	[s1-node3][DEBUG ]     "modified": "2018-02-17 09:30:23.686709", 
	[s1-node3][DEBUG ]     "mons": [
	[s1-node3][DEBUG ]       {
	[s1-node3][DEBUG ]         "addr": "10.132.0.15:6789/0", 
	[s1-node3][DEBUG ]         "name": "s1-node3", 
	[s1-node3][DEBUG ]         "rank": 0
	[s1-node3][DEBUG ]       }, 
	[s1-node3][DEBUG ]       {
	[s1-node3][DEBUG ]         "addr": "10.132.0.16:6789/0", 
	[s1-node3][DEBUG ]         "name": "s1-node2", 
	[s1-node3][DEBUG ]         "rank": 1
	[s1-node3][DEBUG ]       }, 
	[s1-node3][DEBUG ]       {
	[s1-node3][DEBUG ]         "addr": "10.132.0.17:6789/0", 
	[s1-node3][DEBUG ]         "name": "s1-node1", 
	[s1-node3][DEBUG ]         "rank": 2
	[s1-node3][DEBUG ]       }
	[s1-node3][DEBUG ]     ]
	[s1-node3][DEBUG ]   }, 
	[s1-node3][DEBUG ]   "name": "s1-node3", 
	[s1-node3][DEBUG ]   "outside_quorum": [], 
	[s1-node3][DEBUG ]   "quorum": [], 
	[s1-node3][DEBUG ]   "rank": 0, 
	[s1-node3][DEBUG ]   "state": "electing", 
	[s1-node3][DEBUG ]   "sync_provider": []
	[s1-node3][DEBUG ] }
	[s1-node3][DEBUG ] ********************************************************************************
	[s1-node3][INFO  ] monitor: mon.s1-node3 is running
	[s1-node3][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node3.asok mon_status
	[ceph_deploy.mon][INFO  ] processing monitor mon.s1-node1
	[s1-node1][DEBUG ] connection detected need for sudo
	[s1-node1][DEBUG ] connected to host: s1-node1 
	[s1-node1][DEBUG ] detect platform information from remote host
	[s1-node1][DEBUG ] detect machine type
	[s1-node1][DEBUG ] find the location of an executable
	[s1-node1][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node1.asok mon_status
	[ceph_deploy.mon][WARNIN] mon.s1-node1 monitor is not yet in quorum, tries left: 5
	[ceph_deploy.mon][WARNIN] waiting 5 seconds before retrying
	[s1-node1][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node1.asok mon_status
	[ceph_deploy.mon][INFO  ] mon.s1-node1 monitor has reached quorum!
	[ceph_deploy.mon][INFO  ] processing monitor mon.s1-node2
	[s1-node2][DEBUG ] connection detected need for sudo
	[s1-node2][DEBUG ] connected to host: s1-node2 
	[s1-node2][DEBUG ] detect platform information from remote host
	[s1-node2][DEBUG ] detect machine type
	[s1-node2][DEBUG ] find the location of an executable
	[s1-node2][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node2.asok mon_status
	[ceph_deploy.mon][INFO  ] mon.s1-node2 monitor has reached quorum!
	[ceph_deploy.mon][INFO  ] processing monitor mon.s1-node3
	[s1-node3][DEBUG ] connection detected need for sudo
	[s1-node3][DEBUG ] connected to host: s1-node3 
	[s1-node3][DEBUG ] detect platform information from remote host
	[s1-node3][DEBUG ] detect machine type
	[s1-node3][DEBUG ] find the location of an executable
	[s1-node3][INFO  ] Running command: sudo ceph --cluster=ceph --admin-daemon /var/run/ceph/ceph-mon.s1-node3.asok mon_status
	[ceph_deploy.mon][INFO  ] mon.s1-node3 monitor has reached quorum!
	[ceph_deploy.mon][INFO  ] all initial monitors are running and have formed quorum
	[ceph_deploy.mon][INFO  ] Running gatherkeys...
	[ceph_deploy.gatherkeys][DEBUG ] Checking s1-node1 for /etc/ceph/ceph.client.admin.keyring
	[s1-node1][DEBUG ] connection detected need for sudo
	[s1-node1][DEBUG ] connected to host: s1-node1 
	[s1-node1][DEBUG ] detect platform information from remote host
	[s1-node1][DEBUG ] detect machine type
	[s1-node1][DEBUG ] fetch remote file
	[ceph_deploy.gatherkeys][DEBUG ] Got ceph.client.admin.keyring key from s1-node1.
	[ceph_deploy.gatherkeys][DEBUG ] Have ceph.mon.keyring
	[ceph_deploy.gatherkeys][DEBUG ] Checking s1-node1 for /var/lib/ceph/bootstrap-osd/ceph.keyring
	[s1-node1][DEBUG ] connection detected need for sudo
	[s1-node1][DEBUG ] connected to host: s1-node1 
	[s1-node1][DEBUG ] detect platform information from remote host
	[s1-node1][DEBUG ] detect machine type
	[s1-node1][DEBUG ] fetch remote file
	[ceph_deploy.gatherkeys][DEBUG ] Got ceph.bootstrap-osd.keyring key from s1-node1.
	[ceph_deploy.gatherkeys][DEBUG ] Checking s1-node1 for /var/lib/ceph/bootstrap-mds/ceph.keyring
	[s1-node1][DEBUG ] connection detected need for sudo
	[s1-node1][DEBUG ] connected to host: s1-node1 
	[s1-node1][DEBUG ] detect platform information from remote host
	[s1-node1][DEBUG ] detect machine type
	[s1-node1][DEBUG ] fetch remote file
	[ceph_deploy.gatherkeys][DEBUG ] Got ceph.bootstrap-mds.keyring key from s1-node1.
	[ceph_deploy.gatherkeys][DEBUG ] Checking s1-node1 for /var/lib/ceph/bootstrap-rgw/ceph.keyring
	[s1-node1][DEBUG ] connection detected need for sudo
	[s1-node1][DEBUG ] connected to host: s1-node1 
	[s1-node1][DEBUG ] detect platform information from remote host
	[s1-node1][DEBUG ] detect machine type
	[s1-node1][DEBUG ] fetch remote file
	[ceph_deploy.gatherkeys][DEBUG ] Got ceph.bootstrap-rgw.keyring key from s1-node1.
...
Ceph funktioniert nun

	student1@jumphost:~/ceph$ ssh s1-node3 sudo ceph -w
